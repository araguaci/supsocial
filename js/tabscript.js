$(document).ready(function(){
	...
	var Tabs = {
		'Floripa Sup Club 01'	: 'projeto01.php',
		'Floripa Sup Club 02'	: 'projeto02.php'
	}
	...
	the_tabs.click(function(e){
		...
		{	
			...
			$('#contentHolder').html('<img src="../images/tabimages/ajax_preloader.gif" width="64" height="64" class="preloader" />');
